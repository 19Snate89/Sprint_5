...
class StarBurgerRegistration:
    ...
    NAME_FIELD = (By.XPATH, "//fieldset[1]//input") # Поле "Имя" на форме регистрации
    EMAIL_FIELD = (By.XPATH, "//fieldset[2]//input") # Поле "Email" на форме регистрации
    PASS_FIELD = (By.XPATH, "//fieldset[3]//input") # Поле "Пароль" на форме регистрации
...
class StarBurgerLogin:
    ...
    EMAIL_FIELD = (By.XPATH, "//fieldset[1]//input") # Поле "Email" на форме входа
    PASS_FIELD = (By.XPATH, "//fieldset[2]//input") # Поле "Пароль" на форме входа
...
class StarBurgerPersonalCabinet:
    ACCOUNT_TEXT = (By.XPATH, "//p[contains(@class, 'Account_text')]") # Заголовок страницы формы восстановления пароля
    LOGOUT_BUTTON = (By.XPATH, "//button[text() = 'Выход']")  # Кнопка "Войти" на форме восстановления пароля
